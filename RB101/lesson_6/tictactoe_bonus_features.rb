...
def retrieve_computer_mark(allowed_squares, board)
  ...
  if offensive
    ...
    defensive
  elsif allowed_squares.include?(SQUARE_FIVE)
    SQUARE_FIVE
  else
...
def place_piece!(board, current_player)
  if current_player == 'player'
    ...
    computer_places_piece!(board, retrieve_computer_mark(empty_squares(board),
                                                         board))
  end
end
